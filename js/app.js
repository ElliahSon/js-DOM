...
*/
document.getElementsByClassName("profile")[0].innerHTML = "made in china";
...
vid.id = "alias8";
vid.innerHTML = "Old Man Riverwalk";
document.getElementById("aliasParent").appendChild(vid);
//Final Boss
/*9. Without modifying the HTML file, create your own profile.*/
var personalPro = document.getElementsByClassName("block3 col-sm-4")[2];

/*Pic*/
var pro1 = document.getElementByTag("img");